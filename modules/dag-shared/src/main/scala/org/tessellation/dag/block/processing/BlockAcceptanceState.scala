...
object BlockAcceptanceState {
  ...
  implicit val orderCurrencyBlock: Eq[BlockAcceptanceState[CurrencyTransaction, CurrencyBlock]] =
    Eq.fromUniversalEquals[BlockAcceptanceState[CurrencyTransaction, CurrencyBlock]]
//    Order.whenEqual(
